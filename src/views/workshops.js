  ...
  workshopsWrapper.innerHTML = `
    <div class="border-b border-gray-200 dark:border-gray-700">
      <ul class="flex space-x-8 px-6" >
        <li class="flex-1">
          <a id="tab-enrolled" role="tab" type="button" class="w-full flex flex-col md:flex-row content-center items-center justify-center gap-2 py-4 px-3 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:text-gray-700 hover:border-gray-300 transition-colors">
        ...
        <li class="flex-1">
          <button id="tab-created" role="tab" type="button" class="w-full flex flex-col md:flex-row content-center items-center justify-center gap-2 py-4 px-3 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:text-gray-700 hover:border-gray-300 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 text-dark-orange dark:text-light-orange">
        ...
        <li class="flex-1">
          <a id="tab-saved" role="tab" type="button" class="w-full flex flex-col md:flex-row content-center items-center justify-center gap-2 py-4 px-3 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:text-gray-700 hover:border-gray-300 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 text-dark-orange dark:text-light-orange">
